-- =============================================
-- FULL MIGRATION FOR VET CLINIC MANAGEMENT SYSTEM
...
-- Create visit_price_items table
...
CREATE TABLE public.reminders (
  ...
  pet_id UUID REFERENCES public.pets(id) ON DELETE CASCADE NOT NULL,
  client_id UUID REFERENCES public.clients(id) ON DELETE CASCADE NOT NULL,
  reminder_type TEXT NOT NULL CHECK (reminder_type IN ('annual_vaccination', 'deworming', 'blood_test', 'chronic_treatment', 'recheck', 'other', 'follow_up')),
...
-- Create function to handle new user signup (creates clinic automatically)
